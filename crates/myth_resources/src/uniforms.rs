...
// are now auto-generated by the #[myth_material] proc macro.
...
// Unlit, Phong, Physical uniform structs have been moved to the
// respective material modules (auto-generated by #[myth_material]).
